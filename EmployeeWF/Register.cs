...
namespace EmployeeWF
{
    public partial class Register : Form
    {
        SqlConnection connect
            = new SqlConnection(
                @"Data Source=MP\SQLEXPRESS;Initial Catalog=Employees;TrustServerCertificate=True;Integrated Security=True;Connect Timeout=30");
        public Register()
        {
            InitializeComponent();
        }
        ...
        private void signup_showPas_CheckedChanged(object sender, EventArgs e)
        {
